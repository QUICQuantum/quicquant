...
const Efficiency = () => {
    ...
    return (
        <div className="container col-mob">
            <div className="col-lg-6 col-md-12 container-inner-padding " style={{padding:"80px"}}>
                <div className="row">
                    <div
                    ...
                    >
                        ...
                        Optimizing Chatbot Interactions for Improved Customer Service
                        </h2>
                        <p className="theme-mini-text" >Regular performance analysis helps us optimize chatbot interactions to improve customer service metrics.</p> 
                    </div>
                </div>
                <div className="row">
                    <div className="chatbotFeatures">
                        <div className="featuresContainer">
                            ...
                            <h3 className="featureTitle">Complexity Handled</h3>
                          ...
                          <div className="featureCard">
                            ...
                            <h3 className="featureTitle">Improved Service</h3>
            ...
            <div className="col-lg-6 col-md-12 hide-mob" style={{    height: "755px"}}>
            <div className="eff2-left" > 
                 <Image  src="/images/cta-img/eff-left.svg" width='303' height='72' alt='YES'/>
                 </div>
